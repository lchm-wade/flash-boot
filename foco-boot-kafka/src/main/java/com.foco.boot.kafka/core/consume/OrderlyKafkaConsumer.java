 ...
 * @description TODO
 */
public class OrderlyKafkaConsumer implements KafkaResolveApi {
    @Resource
    ...
    public String strategy() {
        return KafkaConsumerStrategy.ORDERLY;
    }
    ...
    public KafkaConsumer consumer(Object obj, Method method, KafkaMsgConsumer consumer) {
        ...
        for (int i = 0; i < consumerNumber; i++) {
            ...
            KafkaConsumerManager kafkaConsumerManager = new KafkaConsumerManager(kafkaConsumer, abstractConsumerFunction, consumer, kafkaProperties.getEnable_auto_commit());
